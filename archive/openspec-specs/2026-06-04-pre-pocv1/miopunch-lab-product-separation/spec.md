# miopunch-lab-product-separation Specification

## Purpose
`miopunch-lab-product-separation` defines the boundary between lab/experiment tooling and product/POC usage.
It ensures lab automation uses the lab binary and keeps lab-only commands out of the product CLI.
