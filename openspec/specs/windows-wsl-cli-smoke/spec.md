# windows-wsl-cli-smoke Specification

## Purpose
Define the CLI-only smoke path used to validate Windows and WSL bidirectional join behavior with captured diagnostics.
