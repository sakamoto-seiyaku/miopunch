# miopunch-mainline-connectivity-matrix-v0 Specification

## Purpose
`miopunch-mainline-connectivity-matrix-v0` defines the MNT-01 mainline connectivity matrix: fixture injection boundaries, case/outcome classification, required evidence, and layered regression gates (smoke/selftest/fulltest) that exercise real `miopunch` peers over controlled network profiles.
