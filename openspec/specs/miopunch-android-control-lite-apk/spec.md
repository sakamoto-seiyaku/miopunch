# miopunch-android-control-lite-apk Specification

## Purpose
Defines the current POC v1 Android control-lite demo APK: a control-only phone UI that packages the current `cmd/miopunch` Android arm64 executable and drives the shared runtime through app-private LocalAPI/state/log paths.
